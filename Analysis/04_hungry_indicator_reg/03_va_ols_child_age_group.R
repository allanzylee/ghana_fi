...
va_ols_input_region <- expand.grid(category=c('lit','num','ef','sel'),
                                                 model=c('~ fs5_child+fs7_cg+fs5_child*age+fs7_cg*age+female+age+treatment+region_north_east+region_northern+region_upper_east+region_upper_west+'))
...
modelsummary(va_ols_region_results,
             ...
             out="/Users/AllanLee/Desktop/Personal Projects/ECON4900/Output/04_hungry_indicator_reg/03_va_ols_child_age_group.html",
             escape = FALSE)
